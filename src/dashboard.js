...
function effortLabel(value) {
  ...
  const labels = { low: 'Low effort', medium: 'Medium effort', high: 'High effort', xhigh: 'Extra high effort', max: 'Maximum effort' }
